    ...
    <div>
         ...
         <div>
            <div class="bg-dark  fixed-top na">
              ...
              <div class="container f_slide">
                  <!--hear the dynamic-->
          <!--  <div class="row bg-white ">
              <img class=" col col-2" src="../pics/cpat.png"/> 
                <div class="col col-9"><h4>head</h4><p>description</p>
                    <div class="ite">  <i class="fa fa-angle-down" id="countitemdown"></i><label id="countofitem" >3</label><i class="fa fa-angle-up" id="countitemup"></i></div>
                    <br /><br />
                     <button class="btn btn-dark float-lg-right">Delete</button>
                </div>
        ...
        <!--    <button class="btn btn-info float-lg-right">Buy Now</button>  -->
       ...
       <div >
        ...
        <button id="checkvalid" class="btn btn-primary float-left" > ok</button>
            ...
            <!--Footer Area-->
                    <footer class="bg-dark position-absolute f_down ">
